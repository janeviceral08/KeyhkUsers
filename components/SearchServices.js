...
<CardItem style={{backgroundColor:'#fff1f3', paddingBottom: 0, marginBottom: 0, paddingLeft: 0, paddingRight: 0, paddingTop: 0,borderRadius: 20, borderWidth:0.5,width:SCREEN_WIDTH/2-10 }}>
      <TouchableOpacity style={{width:SCREEN_WIDTH/2-10, flex: 1}} onPress={()=>this.props.navigation.navigate('CheckoutScreenHotels',{'datas': data, 'cLat': data.slatitude, 'cLong': data.slongitude, 'typeOfRate':this.props.route.params.typeOfRate,'currency':this.props.route.params.currency  })}>
      <FastImage style={styles.productPhoto} source={{ uri: newData[0], headers: { Authorization: 'someAuthToken' },
                  priority: FastImage.priority.normal, }} 
                  resizeMode={FastImage.resizeMode.cover}
      >
...
//console.log('selectedCityUser Homescreen: ',this.state.selectedCityUser)
  ...
  const trans={
    ...
    />
      ...
      <Button block style={{ height: 30, backgroundColor:  "#33c37d", marginTop: 10}}
        onPress={() => this.props.navigation.navigate('CheckoutScreenRentals',{'datas': this.state.vInfo, 'cLat': this.state.vInfo.slatitude, 'cLong': this.state.vInfo.slongitude,'currency':this.props.route.params.currency ,'typeOfRate':this.props.route.params.typeOfRate  })}
      >
       <Text style={{color:'white'}}>Procceed</Text>
      </Button>
    </Card>
