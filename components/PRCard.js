...
export default class PRCard extends Component {
  ...
  rowRenderer = (type, data) => {
    const { name, price, quantity, imageArray, unit, status, id,admin_control, storeId, DayPrice, HourPrice, MonthlyPrice,StatDayPrice,StatHourPrice,StatMonthlyPrice,StatWeeklyPrice,WeeklyPrice, brand ,cluster, addons} = data;
