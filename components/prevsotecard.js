...
return(
           <Card  style={{flex:1, marginHorizontal: 10, borderRadius: 10,backgroundColor: '#6ccddc'}}>
       {this.props.product.withAddons == true ?
        ...
        <View >
        <FastImage
            style={[styles.categoriesPhoto,{borderTopLeftRadius: 10, borderTopRightRadius: 10}]} 
            source={{
        ...
        null : this.props.product.AlwaysOpen?   null :
          ...
          <Text style={[styles.categoriesName,{color: '#274a6e'}]}>{this.props.product.name}  </Text>              
        </View>
      </TouchableHighlight> 
        :        
