...
export default class Products extends Component {
  ...
  rowRenderer = (type, data) => {
    console.log(' sLat ProdCard',this.props.slatitude)
    ...
    return (
      ...
      <Container style={{flex: 1,
        backgroundColor: '#FFF',
          ...
          <TouchableOpacity style={{alignItems:'center',justifyContent:'center', flexDirection:'row',  }} onPress = {()=>{this.props.navigation.navigate('Search', {'storeId': this.props.storeId ,'slongitude': this.props.slongitude,'slatitude': this.props.slatitude,'store_name': this.props.store})}} underlayColor = 'transparent'>
              <View style={{flex: 1}}>
