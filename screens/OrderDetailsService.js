...
console.log('out: ', out);
    return(
        <Root>
          ...
          <Body style={{flex: 3}}>
            <Title style={{color:'white'}}>Trans. No: #00{this.state.datas.OrderNo}</Title>
          </Body>
           <Right style={{flex:1}}>
    ...
    {/*<MapView
         ...
         <Card>
                <CardItem button  onPress={()=> this.setState({VisibleAddInfo: true})}>
                    ...
                    <View style={{flex: 1, flexDirection: 'column', paddingHorizontal: 10}}>
                              ...
                              {this.state.datas.Billing.address}, {this.state.datas.Billing.billing_barangay}, {this.state.datas.Billing.billing_city}, {this.state.datas.Billing.province}
               ...
               <CardItem button  onPress={()=> this.setState({VisibleAddInfo: true})}>
                    ...
                    <Text style={{fontWeight: 'bold', fontSize: 12}}>Service:</Text>
     ...
     <CardItem button  onPress={()=> this.setState({VisibleAddInfo: true})}>
               ...
               <Right>
                   ...
                   <Text style={{fontWeight: 'bold',fontSize: 12}}>Duration:</Text>
                    <Text style={{fontSize: 12}}>{this.state.datas.Duration} {this.state.datas.SelectedPricing}</Text>
                    </Right>
                </CardItem>
