...
import {StyleSheet, TextInput, TouchableOpacity, ActivityIndicator,Dimensions, Alert, Image, FlatList, SafeAreaView, ScrollView, BackHandler, Keyboard, PermissionsAndroid} from 'react-native'
...
<Right style={{top: -80,}}>
<View style={{ backgroundColor: 'white', borderRadius: 10, borderWidth: 1, borderColor: 'black', width: '30%'}}>
<Text style={{textAlign: 'center', borderBottomWidth: 1, borderBottomColor: 'black', fontSize: 12}}>ETA
</Text>
<Text style={{textAlign: 'center', fontSize: 12}}>{this.state.eta.toString()}mins
</Text>
</View>
</Right>
...
<Body >
 ...
 <Text style={{marginLeft: 10, fontSize: 15}}>Call Rider</Text>
 </TouchableOpacity>
  </Body>
  <Body >
 <TouchableOpacity onPress={()=>this.checkOut()} style={{flexDirection: 'row', width: '100%', borderRadius: 5, borderWidth: 2, borderColor: '#019fe8', padding: 10, marginRight: 5}}>
 <Entypo name="message" size={20} color={'black'} />
 <Text style={{marginLeft: 10, fontSize: 15}}>Text Rider</Text>
 </TouchableOpacity>
  </Body>
  <Right >
 <TouchableOpacity onPress={()=>this.setState({visibleAddressModal: true})} style={{flexDirection: 'row', borderRadius: 5, borderWidth: 2, borderColor: '#019fe8', padding: 10, width: '85%'}}>
 <MaterialIcons name="cancel" size={20} color={'black'} />
 <Text style={{marginLeft: 10, fontSize: 15,textAlign: 'center'}}>Cancel</Text>
 </TouchableOpacity>
  </Right>
  </View>
...
onCall(){
  Alert.alert(
    ...
    [
      ...
      { text: 'OK', onPress: () => RNImmediatePhoneCall.immediatePhoneCall('0123456789')}
    ],
    { cancelable: false }
  );
}
