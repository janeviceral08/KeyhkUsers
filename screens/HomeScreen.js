...
import { Container, Content, Button, Left, Right, Icon, Card, CardItem, Badge, Header,Toast, Root,Item,Input } from 'native-base';
...
<TouchableOpacity style={{width: SCREEN_WIDTH/6,}} onPress={()=>this.setState({selectedIndex: 0})}>
         <MaterialIcons name={'storefront'} size={this.state.selectedIndex == 0? 35:30} color={this.state.selectedIndex == 0?'white':'#525252'} style={{alignSelf: 'center', backgroundColor: this.state.selectedIndex == 0?'#ee4e4e':'white',borderRadius: 15, padding: 5}}/>
    
    </TouchableOpacity>
    <TouchableOpacity style={{width: SCREEN_WIDTH/6}} onPress={()=>this.setState({selectedIndex: 1})}>
       <Ionicons name={'md-key-outline'} size={this.state.selectedIndex == 1? 35:30} color={this.state.selectedIndex == 1?'white':'#525252'} style={{alignSelf: 'center', backgroundColor: this.state.selectedIndex == 1?'#396ba0':'white',borderRadius: 15, padding: 5}}/>
    
    </TouchableOpacity>
    <TouchableOpacity style={{width: SCREEN_WIDTH/6}} onPress={()=>this.setState({selectedIndex: 2})}>
<MaterialCommunityIcons name={'car-multiple'}  size={this.state.selectedIndex == 2? 35:30} color={this.state.selectedIndex == 2?'white':'#525252'} style={{alignSelf: 'center', backgroundColor: this.state.selectedIndex == 2?'#28ae07':'white',borderRadius: 15, padding: 5}}/>
    

    </TouchableOpacity>
    <TouchableOpacity style={{width: SCREEN_WIDTH/6}} onPress={()=>this.setState({selectedIndex: 3})}>
<MaterialCommunityIcons name={'account-hard-hat'}  size={this.state.selectedIndex == 3? 35:30} color={this.state.selectedIndex == 3?'white':'#525252'} style={{alignSelf: 'center', backgroundColor: this.state.selectedIndex == 3?'#fd7823':'white',borderRadius: 15, padding: 5}}/>
...
<MaterialCommunityIcons name={'menu'}  size={this.state.selectedIndex == 4? 35:30} color={this.state.selectedIndex == 4?'#396ba0':'#525252'} style={{alignSelf: 'center', backgroundColor: 'white',borderRadius: 15, padding: 5}}/>
   ...
   :this.state.selectedIndex ==1 ?<View style={{flexDirection: 'row', marginLeft: 30}}>
       <Text style={{fontSize: 18, fontWeight: 'bold', marginTop: 5, marginLeft:2}}>Rentals</Text></View>
...
<Text style={{color: this.state.selectedcategories ==2 ?'white':'#525252',}}>     Merch</Text>
